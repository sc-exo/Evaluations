...
for i in $(seq 1 $VM_COUNT); do  
    ...
    DISK="  -drive if=none,id=drive1,format=raw,file=/home/joer/optaneA/virtual-disk/disk$i.raw,cache=none -device virtio-blk-pci,id=blk1,drive=drive1,num-queues=2"
